...
Come server \texttt{HTTP} e implementazione del protocollo WebSocket  è stato deciso di utilizzare \href{https://github.com/ninenines/cowboy}{Cowboy}, una libreria interamente scritta in Erlang che fornisce un ottimo supporto per le WebSocket (tutte le versioni sia standard che non definitive), modello su cui è basato il progetto.
